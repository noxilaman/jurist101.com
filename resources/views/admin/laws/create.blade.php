        ...
        <div class="row justify-content-center">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('admindata.store', $tbapp->id) }}">
                            @csrf
                            ...
                            <div class="row mb-12">
                                <div class="col-md-2">
                                    <label for="i_no"
                                    class="col-form-label text-md-end">{{ __('เลขมาตรา') }}</label>
                                </div>
                                <div class="col-md-4">
                            ...
                            <div class="row mb-12">
                                ...
                                <div class="col-md-4">
                                    <input id="i_subno" type="number"
                                        ...
                                        value="{{ old('i_subno') }}" autocomplete="i_subno" autofocus>
                                ...
                                <div class="col-md-4">
                                    <input id="i_lawno" type="number"
                                        ...
                                        value="{{ old('i_lawno') }}" autocomplete="i_lawno" autofocus>
                            ...
                            <div class="row mb-12">
                                <div class="col-md-2">
                                <label for="name"
                                    class="col-form-label text-md-end">{{ __('ชื่อมาตรา') }}</label>
                                </div>
                                <div class="col-md-10">
                            ...
                            <div class="row mb-12">
                                ...
                                <div class="col-md-10">
                                        ...
                                        value="{{ old('short_note') }}" autocomplete="short_note" autofocus>
                            ...
                            <div class="row mb-3">
                                <div class="col-md-2">
                                <label for="c_url"
                                    class="col-form-label text-md-end">{{ __('link ภาพ') }}</label>
                                </div>
                                <div class="col-md-10">
                                    <input id="c_url" type="text"
                                        class="form-control @error('c_url') is-invalid @enderror" name="c_url"
                                        value="{{ old('c_url') }}" autocomplete="c_url" autofocus>
                            ...
                            <div class="row mb-12">
                                ...
                                <div class="col-md-10">
                                    <input id="important_keys" type="text"
                                        ...
                                        name="important_keys" value="{{ old('important_keys') }}" autocomplete="c_url"
                                        autofocus>
                            ...
                            <div class="row mb-12">
                                ...
                                <div class="col-md-10">
                                    <textarea id="external_factor" class="form-control @error('external_factor') is-invalid @enderror"
                                        name="external_factor" autocomplete="external_factor">{{ old('external_factor') }}</textarea>
                            ...
                            <div class="row mb-12">
                                ...
                                <div class="col-md-10">
                                    <textarea id="internal_factor" class="form-control @error('internal_factor') is-invalid @enderror"
                                        name="internal_factor" autocomplete="internal_factor">{{ old('internal_factor') }}</textarea>
