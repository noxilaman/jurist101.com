                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('adminmainlaws.store') }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="app_img" type="text" class="form-control @error('app_img') is-invalid @enderror" name="app_img" value="{{ old('app_img') }}" autocomplete="app_img">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="group_app" type="text" class="form-control @error('group_app') is-invalid @enderror" name="group_app" value="{{ old('group_app') }}" autocomplete="group_app">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="icon_app" type="text" class="form-control @error('icon_app') is-invalid @enderror" name="icon_app" value="{{ old('icon_app') }}" autocomplete="icon_app">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="short_name" type="text" class="form-control @error('short_name') is-invalid @enderror" name="short_name" value="{{ old('short_name') }}" autocomplete="store_id">
