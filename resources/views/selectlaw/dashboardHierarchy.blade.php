...
@section('content')
    ...
    <div class="law-content-text">
        <div class="row my-2">
            ...
            <div class="col mt-2">
                <a href="{{route('selectlaw.indexCatSection',[$mainapp->id])}}" class="btn btn-secondary">ตามมาตรา</a>
                <a href="{{route('selectlaw.dashboard',[$mainapp->id])}}" class="btn btn-secondary">ตามหัวข้อ</a>
            </div>
        </div>
        <div class="row">
            <div class="col-md-12">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                                        ...
                                        @foreach ($mainCats->where('i_parent_id', 0) as $mainCat)
                                            <li class="nav-item">
                                                <a href="{{ url('lawselect/' . $mainapp->id . '/dashboardcatHierarchy/' . $mainCat->i_id) }}"
                                                    class="nav-link">
                                                ...
                                                <ul>
                                                    ...
                                                    <li class="nav-item">
                                                        <a href="{{ url('/lawview/' . $itemLaw->i_id . '/' . str_replace('/', '_', $itemLaw->c_name) ) }}"
                                                            class="nav-link">
                                                            <i class="nav-icon fas fa-tachometer-alt text-info"></i>
                                                            <p>{{ $itemLaw->c_name }}</p>
                                                        </a>
                                                        <span class="preview-text">
                                                            {!! Str::limit(strip_tags($itemLaw->c_desc), 120) !!}
                                                              ...
                                                              <a href="{{ url('/lawview/' . $itemLaw->i_id . '/' . str_replace('/', '_', $itemLaw->c_name) ) }}" class="btn btn-link btn-sm read-more">เพิ่มเติม</a>
                                                    </li>
                                                @endforeach
                                                </ul>
                                                @endif
                                                        ...
                                                        @foreach ($parameters as $parameterLavel1)
                                                            @if ($parameterLavel1 == $mainCat->i_id)
                                                                ...
                                                                @foreach ($level1s as $level1)
                                                                    <li class="nav-item">
                                                                        <a href="{{ url('lawselect/' . $mainapp->id . '/dashboardcatHierarchy/' . $mainCat->i_id . '/' . $level1->i_id) }}"
                                                                        ...
                                                                        @foreach ($parameters as $parameterLevel2)
                                                                            @if ($parameterLevel2 == $level1->i_id)
                                                                                ...
                                                                                @foreach ($level2s as $level2)
                                                                                    <li class="nav-item">
                                                                                        <a href="{{ url('lawselect/' . $mainapp->id . '/dashboardcatHierarchy/' . $mainCat->i_id . '/' . $level1->i_id . '/' . $level2->i_id) }}"
                                                                                        ...
                                                                                        @foreach ($parameters as $parameterLevel3)
                                                                                            @if ($parameterLevel3 == $level2->i_id)
                                                                                                ...
                                                                                                @foreach ($level3s as $level3)
                                                                                                    <li class="nav-item">
                                                                                                        <a href="{{ url('lawselect/' . $mainapp->id . '/dashboardcatHierarchy/' . $mainCat->i_id . '/' . $level1->i_id . '/' . $level2->i_id . '/' . $level3->i_id) }}"
                                                                                                        ...
                                                                                                        @foreach ($parameters as $parameterLevel4)
                                                                                                            @if ($parameterLevel4 == $level3->i_id)
                                                                                                                ...
                                                                                                                @foreach ($level4s as $level4)
                                                                                                                    <li class="nav-item">
                                                                                                                        <a href="{{ url('lawselect/' . $mainapp->id . '/dashboardcatHierarchy/' . $mainCat->i_id . '/' . $level1->i_id . '/' . $level2->i_id . '/' . $level3->i_id.'/'.$level4->i_id) }}"
