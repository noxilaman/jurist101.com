...
@section('content')
    <div class="law-content-text">
        ...
        <div class="card p-4">
            <form action="{{ route('selectlaw.indexCatSection', [$mainapp->id]) }}" method="GET">
                <div class="input-group w-100 mb-2">
                    ...
                    <div class="input-group-append">
                        <a href="{{ route('selectlaw.indexCatSection', [$mainapp->id]) }}" class="btn btn-lg btn-default"
                            title="ล้างค่า">
            ...
            @foreach ($mainLaws as $mainLaw)
                <div class="card-content">
                    ...
                    <a href="{{ url('/lawview/' . $mainLaw->i_id . '/' . str_replace('/', '_', $mainLaw->c_name) ) }}" style="color: black">
