                ...
                <div class="tab-pane fade show active" id="nav-all">
                    ...
                    @if (!empty($mainLaws) && $mainLaws->count() > 0)
                        @if ($searchType == 'deka')
                            @foreach ($mainLaws as $mainLaw)
                                <div class="card card-content">
                                    <a href="{{ url('/nonmember/dekaview/' . $mainLaw->id . '/' . str_replace('/', '_', $mainLaw->c_name)) }}"
                                        style="color: black">
                        ...
                        @else
                            @foreach ($mainLaws as $mainLaw)
                                <div class="card card-content">
                                    <a href="{{ url('/nonmember/lawview/' . $mainLaw->i_id . '/' . str_replace('/', '_', $mainLaw->c_name))."?searchtext=".$searchTxt }}"
                                        style="color: black">
