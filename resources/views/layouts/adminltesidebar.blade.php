...
<aside class="main-sidebar sidebar-light-info elevation-0">
    <!-- Brand Logo -->
    <a href="{{ url('/search') }}" class="brand-link">
        <img src="{{ asset('jurist-logo.png') }}" alt="AdminLTE Logo"
    ...
    <div class="sidebar">
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                ...
                <li class="nav-item">
                    <a href="/search" class="nav-link{{ Route::currentRouteNamed('search') ? ' active' : '' }}">
                ...
                <li class="nav-item">
                    <a href="/bookmarks" class="nav-link bookmarks{{ Route::currentRouteNamed('bookmarks') ? ' active' : '' }}">
