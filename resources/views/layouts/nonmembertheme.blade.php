...
@php
    $keywordseo = '';
    if (isset($searchTxt)) {
        $keywordseo .= "ค้นหา " . $searchTxt;
    }
if(isset($mainapp)){
	$keywordseo .= " ".$mainapp->name;
}
if(isset($lawdata)){
	if(isset($lawdata->mainlaw)){
		$keywordseo .= " ".$lawdata->mainlaw->name." ".$lawdata->c_name;
	}else{
		
	 	$keywordseo .= " ".$lawdata->c_name;
...
<head>
    ...
    <meta name="description" content="Jurist101 ค้นหากฎหมาย ค้นหาฎีกา ค้นหารัฐธรรมนูญ {{ $keywordseo }}" />
    <meta name="keyword" content="ค้นหากฎหมาย, ค้นหาฎีกา, ค้นหารัฐธรรมนูญ,รัฐธรรมนูญ,กฎหมาย,ฎีกา ,{{ $keywordseo }}" />
    <meta name="author" content="Jurist101" />
    <title>{{ config('app.name') }} ค้นหากฎหมายง่ายๆ {{ $keywordseo }}</title>
...
<body class="hold-transition sidebar-mini">
    <div class="wrapper">
        ...
        @include('layouts.nonmemberltenav')

        @include('layouts.nonmemberltesidebar')
