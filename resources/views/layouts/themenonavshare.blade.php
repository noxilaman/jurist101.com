...
<head>
    ...
    <title>Jurist101 | {{ $lawdata->mainlaw->name ?? ''}} {{ $lawdata->c_name ?? ''}} </title>
    ...
    <script type='text/javascript' src='https://platform-api.sharethis.com/js/sharethis.js#property=66cdfdfae8480b00195529af&product=sop' async='async'></script>
	<!-- Google tag (gtag.js) -->
